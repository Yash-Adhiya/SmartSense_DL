...
# Please note that the for this code, I have taken help from the internet and other repo as this is a standard segmentation code. Images used here are self-downloaded ones. 
...
if __name__ == '__main__':
    img1 = cv2.imread(r"C:\Users\YashAdhiya\Desktop\model2\Orange\2.jpg")
